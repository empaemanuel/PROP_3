...
write_to_file(OutputFile,ParseTree,Variables):- 
...
/* Output element with incorrect variable-value format. */
write_list(Stream,[IdentValue|Vars]):-
	write(Stream,IdentValue),
	nl(Stream), 
	write_list(Stream,Vars).
